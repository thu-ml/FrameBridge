...
class UCF101Images(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.video_frame_num = len(self.video_frame_files) // self.use_image_num
    ...
    def __getitem__(self, index):
        ...
        for i in range(self.use_image_num):
            while True:
                try:      
                    video_frame_path = self.video_frame_files[index * self.use_image_num + i]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-path", type=str, default="data/UCF-101")
    parser.add_argument("--frame-data-path", type=str, default="data/UCF-101-image")
    parser.add_argument("--frame-data-txt", type=str, default="data/UCF-101-frame-data.txt")
