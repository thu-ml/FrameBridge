...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def forward(self, text):
        ...
        z = self.encode_with_transformer(tokens.to(f"cuda:{torch.distributed.get_rank() % 8}"))
        # z = self.encode_with_transformer(tokens.to(f"cuda:{torch.distributed.get_rank()}"))
        return z
