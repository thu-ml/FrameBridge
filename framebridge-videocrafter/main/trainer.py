...
from utils_train import set_logger, init_workspace, load_checkpoints, load_diffusion_checkpoints, load_np_model
...
if __name__ == "__main__":
    ...
    if hasattr(config.model, "t2v_diffusion_checkpoint"):
        model = load_diffusion_checkpoints(model, config.model.t2v_diffusion_checkpoint)
        print("loaded diffusion parameters from ", config.model.t2v_diffusion_checkpoint)
